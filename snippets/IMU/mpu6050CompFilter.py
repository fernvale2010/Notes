...
def read_all():
    ...
    # compute deg/sec
    # MPU6050 returns values in 2's complement format..
...
#//sg: appears to initialize IMU to the "current" angle given by accelerometer - initial gyro Offset (offset error)
...
for i in range(0, int(3.0 / time_diff)):
    ...
    #//sg: angle from gyro is obtained by summing the changes (ie, integration)
