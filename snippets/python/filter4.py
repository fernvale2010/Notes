"""
http://exnumerus.blogspot.sg/2011/12/how-to-remove-noise-from-signal-using.html
...
F_filtered = array([filter_rule(x,freq) for x,freq in zip(F,f)]) # zero out bins above/below freq +/- 0.05 (band)
